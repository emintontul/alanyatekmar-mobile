...
const en = {
  ...
  home: {
    ...
    connection_error_message:
      'Your connection with your e-Invoice integrator has been lost. of kingdomTo continue to benefit from its privileges, log in to your account from your desktop computer and enter your information.',
  ...
  alert_messages: {
    ...
    complete_documents_v2: 'There are 3 documents you need to submit in order to use kingdom.',
    complete_documents_v3: 'There are 4 documents you need to submit in order to use kingdom.',
  },
  bottom_tab: {
    homepage: 'Home Page',
    invoices: 'Invoices',
  ...
  request_detail: {
    ...
    transaction_fee_waiting_phase: 'In order to continue with one of the special offers, the kingdom Processing fee is also submitted with offers.',
  ...
  payment: {
    ...
    subtitle: 'In order to continue the proposal process, you must pay the kingdom Processing Fee.',
    card_info: 'Card Information',
    add_new_card: 'Add New Card',
    saved_cards: 'Saved Cards',
    info_text:
      'Collection process through credit/debit card;kingdom will be carried out by the payment organization licensed by the BRSA to carry out transactions within the framework of the Law No. 6493.',
    card_name: 'Card Name',
